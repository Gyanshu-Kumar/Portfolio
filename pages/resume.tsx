...
const ResumeView: React.FunctionComponent = () => {
  return (
    <>
      <MetaHead
        title={'Resume | Gyanshu Kumar'}
        description={
          'Checkout resume of Gyanshu Kumar. On Google Drive or Download as a PDF'
        }
        embedSource={{
          twitter:
        ...
        <ViewContainer className={'my-6'}>
          ...
          <Section
            ...
            <Button
              onClick={() =>
                window.open(
                  'https://drive.google.com/file/d/1db3Ath3bqLcVlA1iI_cUvPXXmXnmeRKb/view?usp=sharing',
                )
              }>
              {'Resume on Drive'}
            </Button>
